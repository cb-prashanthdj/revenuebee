...
const UsageAttributes = [
  ...
  },
  {
    ...
    method: "Conversation channel",
    type: "text",
    values: [...MetricAttribute],
  },
  {
    id: "ai_tokens_used",
    method: "AI tokens used",
    type: "text",
    values: [...MetricAttribute],
  },
  {
...
export const MetricUsageAttributes: unknown[] = [...UsageAttributes];
