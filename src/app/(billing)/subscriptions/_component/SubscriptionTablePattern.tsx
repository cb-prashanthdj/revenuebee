...
const SubscriptionTablePattern: React.FC<SubscriptionTableProps> = ({
  selectors = {},
  tabledata,
  filteredTableData,
  reset = false,
  ...
  const headerClassNames = {
    ...
    customerName: "w-0 whitespace-nowrap",
    plan: "w-0 whitespace-nowrap",
    status: "w-0",
    statusValue: "hidden",
    netPayment: "w-0 whitespace-nowrap text-right",
    createdOn: "w-0 whitespace-nowrap",
    billingAddress: "w-auto",
    currency: "hidden",
    channel: "w-auto",
    language: "hidden",
    autoCollection: "hidden",
    taxRegNumber: "hidden",
  };
  ...
  const cellClassNames = {
    checkbox: "w-0 whitespace-nowrap",
    id: "w-0 whitespace-nowrap",
    customerName: "w-0 whitespace-nowrap font-semibold",
    subscription: "w-0 whitespace-nowrap",
    status: "w-0",
    statusValue: "hidden",
    netPayment: "w-0 whitespace-nowrap text-right",
...
export default SubscriptionTablePattern;
