import { Button, Tabs, TabsContent, TabsList } from "cb-sting-react-ts";
...
export const CurrencyCard2 = () => {
  ...
  const getFilteredCardData = (currency: string) => {
...
export const PlanCardWith2Rows = () => {
  return (
    <div>
      <div className="grid grid-cols-1 gap-2">
        ...
        <div className="md:flex justify-between bg-neutral-25 rounded-md px-4 py-3 leading-5 text-neutral-500 space-x-8 space-y-4 md:space-y-0">
          <div className="flex items-center gap-4">
            ...
            <span>
              USD upcoming payment on{" "}
              <span className="whitespace-nowrap">20 Jan 2025</span>
            </span>
          </div>
          <div className="flex justify-end">
            <Button
...
const currencyCardComponents = {
  uc4_a1: PlanCardWith2Rows,
  uc4_a2: CurrencyCard1,
  uc4_a3: CurrencyCard1,
  uc4_a4: CurrencyCard1,
};
