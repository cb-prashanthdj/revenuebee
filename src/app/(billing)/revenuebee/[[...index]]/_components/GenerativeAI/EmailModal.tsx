...
We noticed that we need to update your payment method information.
...
Acme Corp`);
  ...
  return (
    <SModal.Root>
      ...
      {children ? <SModal.Trigger asChild>{children}</SModal.Trigger> : null}
      ...
      >
        ...
        <SModal.Body className="py-4">
          ...
          <div className="mb-6">
            ...
            <div className="border rounded-md p-4">
              <textarea
                className="w-full min-h-[200px] resize-none bg-transparent border-0 focus:outline-none text-gray-700"
                value={emailContent}
        ...
        <SModal.Footer>
          ...
          <SModal.Close asChild>
            <Button onClick={() => onSend(fromEmail)}>Send Emails</Button>
          </SModal.Close>
        </SModal.Footer>
      </SModal.Content>
    </SModal.Root>
