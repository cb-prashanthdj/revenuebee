    ...
    <SModal.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        <SModal.Body className="py-4">
          ...
          <div className="mb-6">
            ...
            <div className="border rounded-md p-4">
              ...
              <p className="mb-4">
                We hope this message finds you well. Our records indicate that
                you have an outstanding invoice that is currently overdue.
              </p>
              <p className="mb-4 ">[Update Payment Method]</p>
              <p className="mb-4 ">
                We kindly request that you settle this payment at your earliest
                convenience to maintain your account in good standing.
              </p>
              <div className="mb-4">
              ...
              <div className="space-y-2">
                <ul className=" divide-gray-200">
                  <li className=" flex">
                    ...
                    <span id="invoice-number" className="flex-1">
                      {"{invoice_number}"}
                    </span>
                  </li>
                  <li className=" flex">
                    <span className="w-40 font-medium">Amount Due:</span>
                    <span id="amount-due" className="flex-1">
                      {"{amount_due}"}
                    </span>
                  </li>
                  <li className=" flex">
                    <span className="w-40 font-medium">Due Date:</span>
                    <span id="due-date" className="flex-1">
                      {"{due_date}"}
                    </span>
                  </li>
                  <li className=" flex">
                    <span className="w-40 font-medium">Days Overdue:</span>
                    <span id="days-overdue" className="flex-1  font-semibold">
                      {"{days_overdue}"}
                    </span>
                  </li>
                </ul>
        ...
        <SModal.Footer>
          ...
          <SModal.Close asChild>
            <Button onClick={() => onSend(fromEmail)}>Send Remainders</Button>
          </SModal.Close>
        </SModal.Footer>
      </SModal.Content>
    </SModal.Root>
